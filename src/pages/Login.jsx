...
export default function Login() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 font-inter transition-colors duration-300
      ...
      <div className={`w-full max-w-md p-8 rounded-xl shadow-2xl space-y-8 transition-all duration-300
                      ${isCurrentThemeDark ? 
        ...
        <div className="text-center space-y-2">
          ...
          <p className={`text-sm ${isCurrentThemeDark ? 'text-gray-400' : 'text-gray-500'}`}>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            <label htmlFor="email" className={`block text-sm font-medium ${isCurrentThemeDark ? 'text-gray-300' : 'text-gray-600'}`}>
              Email Address
            </label>
            <input
              id="email"
          ...
          <div className="space-y-2">
            <label htmlFor="password" className={`block text-sm font-medium ${isCurrentThemeDark ? 'text-gray-300' : 'text-gray-600'}`}>
              Password
            </label>
            <input
              id="password"
          ...
          {error && (
            <div className={`p-3 rounded-md flex items-center ${isCurrentThemeDark ? 'bg-red-900/50 text-red-200' : 'bg-red-100 text-red-700'}`}>
